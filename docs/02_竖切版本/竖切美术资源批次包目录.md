...
| --- | --- | --- | --- | ---: | ---: | --- | --- |
| idle | `source_frames/protag_idle/` | `WheatearEditor/assets/vertical_slice/side_combat/sheets/protag_idle_strip.png` | body_512 | 8 | 8 | 4096x512 | 呼吸待机，魔剑微光 |
| run | `source_frames/protag_run/` | `WheatearEditor/assets/vertical_slice/side_combat/sheets/protag_run_strip.png` | body_512 | 4 | 8 | 2048x512 | 横向奔跑，脚步清楚 |
| jump_start | `source_frames/protag_jump_start/` | `WheatearEditor/assets/vertical_slice/side_combat/sheets/protag_jump_start_strip.png` | body_512 | 1 | 18 | 512x512 | 起跳发力 |
| jump_loop | `source_frames/protag_jump_loop/` | `WheatearEditor/assets/vertical_slice/side_combat/sheets/protag_jump_loop_strip.png` | body_512 | 1 | 12 | 512x512 | 空中滞留 |
| fall | `source_frames/protag_fall/` | `WheatearEditor/assets/vertical_slice/side_combat/sheets/protag_fall_strip.png` | body_512 | 1 | 12 | 512x512 | 下落姿态 |
| land | `source_frames/protag_land/` | `WheatearEditor/assets/vertical_slice/side_combat/sheets/protag_land_strip.png` | body_512 | 1 | 18 | 512x512 | 落地缓冲 |
| basic1 | `source_frames/protag_basic1/` | `WheatearEditor/assets/vertical_slice/side_combat/sheets/protag_basic1_strip.png` | body_512 | 4 | 14 | 2048x512 | 第一段平砍 |
| basic2 | `source_frames/protag_basic2/` | `WheatearEditor/assets/vertical_slice/side_combat/sheets/protag_basic2_strip.png` | body_512 | 4 | 12 | 2048x512 | 第二段反手斩 |
| basic3 | `source_frames/protag_basic3/` | `WheatearEditor/assets/vertical_slice/side_combat/sheets/protag_basic3_strip.png` | body_512 | 4 | 10 | 2048x512 | 第三段收尾斩 |
| air_basic | `source_frames/protag_air_basic/` | `WheatearEditor/assets/vertical_slice/side_combat/sheets/protag_air_basic_strip.png` | body_512 | 4 | 14 | 2048x512 | 空中跳斩 |
| launcher | `source_frames/protag_launcher/` | `WheatearEditor/assets/vertical_slice/side_combat/sheets/protag_launcher_strip.png` | body_512 | 2 | 10 | 1024x512 | S+J 裂空上挑，使用当前 sheet 第 2/4 帧 |
...
| break_limit | `source_frames/protag_break_limit/` | `WheatearEditor/assets/vertical_slice/side_combat/sheets/protag_break_limit_strip.png` | body_512 | 4 | 8 | 2048x512 | 断限追击，角色本体使用 sheet 第 2/3 帧 |
| hurt | `source_frames/protag_hurt/` | `WheatearEditor/assets/vertical_slice/side_combat/sheets/protag_hurt_strip.png` | body_512 | 4 | 14 | 2048x512 | 受击 |
