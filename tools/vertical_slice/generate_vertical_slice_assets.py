...
def main() -> None:
    ...
    vn_background(backgrounds / "school_road.png", ((154, 206, 230), (248, 202, 148)), "school")
    vn_background(backgrounds / "isekai_forest.png", ((68, 116, 102), (24, 38, 46)), "forest")
    vn_background(backgrounds / "forest_camp.png", ((36, 54, 70), (16, 20, 28)), "camp")
    vn_background(backgrounds / "chapter3_road.png", ((92, 132, 146), (44, 64, 86)), "forest")

    sc = ASSET_ROOT / "side_combat"
    save(pixel_player(), sc / "characters" / "player_magic_swordsman.png")
    save(pixel_bear(), sc / "enemies" / "bear_husband.png")
    save(pixel_bear().resize((96, 72), Image.Resampling.NEAREST), sc / "enemies" / "small_claw_beast.png")
    vn_background(sc / "backgrounds" / "black_forest_stage.png", ((50, 78, 72), (16, 22, 30)), "forest")
    save(effect("slash"), sc / "effects" / "slash_basic.png")
    save(effect("launcher"), sc / "effects" / "slash_launcher.png")
    save(effect("bolt"), sc / "effects" / "magic_bolt.png")
    save(effect("support"), sc / "effects" / "ally_support.png")
    save(effect("claw"), sc / "effects" / "enemy_claw.png")
    save(effect("projectile"), sc / "effects" / "enemy_projectile.png")
    save(icon("core"), sc / "ui" / "mat_magic_core.png")
    save(icon("sinew"), sc / "ui" / "mat_beast_sinew.png")
    save(icon("claw"), sc / "ui" / "mat_beast_claw.png")
    save(icon("sword"), sc / "ui" / "magic_sword_icon.png")
