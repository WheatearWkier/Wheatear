...
def main() -> None:
    ...
    save(pixel_player(), sc / "characters" / "protag_magic_swordsman.png")
    save(pixel_bear(), sc / "enemies" / "boss_bear_husband.png")
    save(pixel_bear().resize((96, 72), Image.Resampling.NEAREST), sc / "enemies" / "en_claw_beast_small.png")
    vn_background(sc / "backgrounds" / "bg_black_forest_stage.png", ((50, 78, 72), (16, 22, 30)), "forest")
    save(effect("slash"), sc / "effects" / "vfx_basic_slash.png")
    save(effect("launcher"), sc / "effects" / "vfx_launcher_slash.png")
    save(effect("bolt"), sc / "effects" / "vfx_magic_bolt.png")
    save(effect("support"), sc / "effects" / "vfx_ally_support.png")
    save(effect("claw"), sc / "effects" / "vfx_enemy_claw.png")
    save(effect("projectile"), sc / "effects" / "vfx_enemy_projectile.png")
