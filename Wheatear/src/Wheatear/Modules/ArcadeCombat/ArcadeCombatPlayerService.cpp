...
namespace Wheatear::ArcadeCombatPlayerService {
    ...
    namespace {
        ...
        static WAO::ActionRecipe ResolveWeaponRecipe(ArcadeWeaponType weapon)
        {
            if (const WAO::ActionRecipe* recipe = WAO::ActionDatabase::Find(
                ArcadeCombatActionCatalog::WeaponActionId(weapon)))
            {
                return *recipe;
            }

            WAO::ActionRecipe recipe = ArcadeCombatActionCatalog::BuildWeaponRecipe(weapon);
        ...
        const PlayerInputState& input)
    {
        ...
        case ArcadeWeaponType::Gun:
            ...
            payload.Damage = ArcadeCombatActionCatalog::PrimaryDamage(recipe, 8.0f);
        ...
        case ArcadeWeaponType::Cannon:
            ...
            payload.Damage = ArcadeCombatActionCatalog::PrimaryDamage(recipe, 24.0f);
        ...
        case ArcadeWeaponType::Katana:
            ...
            payload.Damage = ArcadeCombatActionCatalog::PrimaryDamage(recipe, 18.0f);
