...
namespace Wheatear::SideCombatTuningService {
    ...
    std::filesystem::path TuningSourcePath(const SideCombatLevelComponent& level)
    {
    ...
    {
        return fieldId == "ComboDropDelay"
            || fieldId == "LaneMinY"
            || fieldId == "LaneMaxY"
            || fieldId == "LaneSpeedScale"
            || fieldId == "LaneAcceleration"
            || fieldId == "SortScale"
            || fieldId == "ShadowMinAlpha"
            || fieldId == "ShadowMaxAlpha"
            || fieldId == "ShadowAirFadeHeight"
            || fieldId == "ShadowOffset"
            || fieldId == "ShadowColor"
            || fieldId == "MoveSpeed"
            || fieldId == "MaxJumps"
            || fieldId == "JumpImpulse"
            || fieldId == "Gravity"
            || fieldId == "AirControl"
            || fieldId == "JumpBufferTime"
            || fieldId == "CoyoteTime"
            || fieldId == "GroundAcceleration"
            || fieldId == "GroundFriction"
            || fieldId == "BasicCooldown"
            || fieldId == "BasicFinisherExtraCooldown"
            || fieldId == "LauncherCooldown"
            || fieldId == "MagicBoltCooldown"
            || fieldId == "AllySupportCooldown"
            || fieldId == "DashCooldown"
            || fieldId == "HealItemCooldown"
            || fieldId == "ManaItemCooldown"
            || fieldId == "AttackBuffItemCooldown"
            || fieldId == "DashManaCost"
            || fieldId == "DashSpeed"
            || fieldId == "DashInvulnerableTime"
            || fieldId == "BasicChainWindow"
            || fieldId == "LauncherChainWindow"
            || fieldId == "MagicChainWindow"
            || fieldId == "SupportChainWindow"
            || fieldId == "BossProtectionMax"
            || fieldId == "BossProtectionDecayPerSecond"
            || fieldId == "BossProtectionLimitTime"
            || fieldId == "BossProtectionForceFallVelocity"
            || fieldId == "BossProtectionBreakLimitThreshold"
            || fieldId == "BreakLimitProtectionReduce"
            || fieldId == "GroundResetDelay"
            || fieldId == "ShowBossProtectionHud"
            || fieldId == "ShowCombatStateHud"
            || fieldId == "AirActionLimit"
            || fieldId == "AirActionLimitAfterBreak"
            || fieldId == "BreakLimitEnabled"
            || fieldId == "BreakLimitDebugKeyEnabled"
            || fieldId == "ShowBreakLimitHint"
            || fieldId == "AirBasicCooldown"
            || fieldId == "AirChaseCooldown"
            || fieldId == "BreakLimitCooldown"
            || fieldId == "BreakLimitMinCombo"
            || fieldId == "BreakLimitMaxHeight"
            || fieldId == "BreakLimitFallingVelocity"
            || fieldId == "BreakLimitHangImpulse"
            || fieldId == "BreakLimitHeightBoost"
            || fieldId == "BreakLimitGaugeCost"
            || fieldId == "MagicSwordGaugeMax"
            || fieldId == "GaugeGainGroundHit"
            || fieldId == "GaugeGainAirHit"
            || fieldId == "GroundThreatHeight"
            || fieldId == "HighAirSafetyHeight"
            || fieldId == "InitialAttackDelay"
            || fieldId == "AttackRangePadding"
            || fieldId == "LaneAttackPadding"
            || fieldId == "BossPreferredRangeBonus"
            || fieldId == "GruntMoveSpeedScale"
            || fieldId == "BossMoveSpeedScale"
            || fieldId == "GruntLaneSpeedScale"
            || fieldId == "BossLaneSpeedScale"
            || fieldId == "XApproachAcceleration"
            || fieldId == "XBrakeAcceleration"
            || fieldId == "LaneApproachAcceleration"
            || fieldId == "LaneBrakeAcceleration"
            || fieldId == "BearBossMoveSpeed"
            || fieldId == "BearBossAggroRange"
            || fieldId == "BearBossAttackRange"
            || fieldId == "BearBossPreferredRange"
            || fieldId == "BearBossAttackInterval"
            || fieldId == "BearBossLaneTolerance"
            || fieldId == "BearBossMidHealthThreshold"
            || fieldId == "BearBossLowHealthThreshold"
            || fieldId == "BearBossMidAttackInterval"
            || fieldId == "BearBossLowAttackInterval"
            || fieldId == "BearBossChargeDistance"
            || fieldId == "BearBossShockwaveDistance"
            || fieldId == "BearBossChargeSpeed"
            || fieldId == "PickupRadius"
            || fieldId == "AttractRadius"
            || fieldId == "AttractSpeed";
    }
